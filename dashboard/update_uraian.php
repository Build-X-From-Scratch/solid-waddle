...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data
    $update = mysqli_query($connect, "UPDATE uraian SET 
                judul='$judul',
                uraian_singkat='$uraian_singkat',
                uraian_lengkap='$uraian_lengkap',
                photo='$photo'
                WHERE id_uraian=$id");
    ...
    if ($update) {
        ...
        $error = "Gagal mengupdate data: " . mysqli_error($connect);
    }
}
?>
...
<head>
    ...
    <title>Edit Uraian - Kecamatan Tinanggea</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Edit Data Uraian</h1>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Edit Uraian</h6>
                        </div>
                        <div class="card-body">
                            <?php if (isset($error)): ?>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (!empty($row['photo'])): ?>
                                        <img src="../assets/images/img/<?= htmlspecialchars($row['photo']); ?>" width="120" class="rounded mb-2">
                                    <?php else: ?>

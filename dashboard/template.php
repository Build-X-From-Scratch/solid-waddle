...
<head>
    ...
    <title>Dashboard Template - Kecamatan Tinanggea</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Dashboard Template</h1>
                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Template Content</h6>
                                </div>
                                <div class="card-body">
                                    <p>This is a template for dashboard pages. Replace this content with your specific page content.</p>
                                    <p>Features included:</p>
                                    <ul>
                                        <li>Session management and login check</li>
                                        <li>Complete sidebar with navigation</li>
                                        <li>Topbar with user dropdown</li>
                                        <li>Responsive layout</li>
                                        <li>DataTables support</li>
                                    </ul>
                                </div>
                            </div>
                        </div>

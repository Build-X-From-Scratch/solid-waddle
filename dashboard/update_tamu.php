...
$id = intval($_GET['id_tamu']);
$data = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM tamu WHERE id_tamu=$id"));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nama !== '' && $email !== '') {
        $update = "UPDATE tamu 
                   SET nama='$nama', email='$email', organisasi='$organisasi', alamat='$alamat', pesan='$pesan' 
                   WHERE id_tamu=$id";
...
<head>
    ...
    <title>Edit Data Tamu - Kecamatan Tinanggea</title>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="organisasi" value="<?= htmlspecialchars($data['organisasi']); ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input type="text" name="alamat" value="<?= htmlspecialchars($data['alamat']); ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Pesan</label>
                                    <textarea name="pesan" rows="4" class="form-control"><?= htmlspecialchars($data['pesan']); ?></textarea>
                                </div>

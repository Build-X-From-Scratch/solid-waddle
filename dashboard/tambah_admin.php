...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $email && $password) {
        ...
        if ($ok) {
            ...
            $error = "Gagal menambah admin: " . mysqli_error($connect);
        }
    } else {
...
<head>
    ...
    <title>Tambah Admin - Kecamatan Tinanggea</title>
...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item"><a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAdmin"><i class="fas fa-fw fa-cogs"></i><span>Admin</span></a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3"><h6 class="m-0 font-weight-bold text-primary">Form Tambah Admin</h6></div>
                        <div class="card-body">
                            <?php if (isset($error)): ?>
